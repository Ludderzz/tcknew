import { publicProcedure, router } from "./_core/trpc.js"; // 👈 Add .js
import { z } from "zod";
import { fetchAllCompetitionEntries } from "./scraper.js"; // 👈 Add .js
import { getLiveWinners } from "./winners.js"; // 👈 Add .js
import { scrapeFacebookPostComments, processFacebookCommentsAndSave } from "./facebookPicker.js"; // 👈 Add .js
